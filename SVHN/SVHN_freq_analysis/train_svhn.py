...
if (model_type == "low_freq"):
    ...
    model.load_weights("svhn_weights_best_" + model_type + "_"+ str(lim_freq) +".hdf5")
...
if (model_type == "high_freq"):
    ...
    print("Accuracy on high freq train set: " + str(model.evaluate(X_train, Y_train, verbose=0)[1]))
    print("Accuracy on high freq test set: " +  str(model.evaluate(X_test, Y_test, verbose=0)[1]))
    ...
    model.save("models/SVHN_high_freq_" + str(lim_freq) + ".h5")
